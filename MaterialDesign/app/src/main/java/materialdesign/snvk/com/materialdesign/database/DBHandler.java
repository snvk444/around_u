package materialdesign.snvk.com.materialdesign.database;
...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public static final String IDENTIFIER_GAS = "Gas";
    public static final String IDENTIFIER_TRAIN = "Train";
    public static final String IDENTIFIER_BUS = "Bus";
